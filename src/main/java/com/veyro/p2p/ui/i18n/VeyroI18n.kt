...
object VeyroI18n {
    private val english = mapOf(
        ...
        "Reproduzir" to "Playback",
        "Dispositivos de som" to "Audio devices",
        "Mídia Veyro" to "Veyro media",
        "Nenhuma mídia ativa" to "No active media",
        "Mídia do aparelho conectado" to "Media from the connected device",
        "Pré-visualização Veyro" to "Veyro preview",
        "Volumes individuais" to "Individual volumes",
        "A saída ativa é informada pelo outro aparelho. Os volumes abaixo podem ser alterados individualmente." to "The active output is reported by the other device. The volumes below can be changed individually.",
        "Alto-falante" to "Speaker",
        "Áudio Bluetooth" to "Bluetooth audio",
        "Saída de áudio" to "Audio output",
        "Em uso" to "In use",
        "Mídia" to "Media",
        "Toque" to "Ringtone",
        "Alarme" to "Alarm",
        ...
        "Chamadas" to "Calls",
        "Sistema" to "System",
        "Reproduzindo" to "Playing",
        "Pausado" to "Paused",
        "Carregando" to "Buffering",
        "Parado" to "Stopped",
        "Conectando" to "Connecting",
